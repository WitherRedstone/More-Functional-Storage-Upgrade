...
public class CustomUpgradeRecipesProvider {
    ...
    public static void buildRecipes(ModRecipesProvider helper, RecipeOutput recipeOutput) {
        ...
        ShapedRecipeBuilder.shaped(RecipeCategory.MISC, ModItems.GENERATOR_UPGRADE_SMITHING_TEMPLATE.get())
                ...
                .unlockedBy("has_generator_upgrade_smithing_template", ModRecipesProvider.has(Items.HEART_OF_THE_SEA))
                .save(recipeOutput);
        ShapedRecipeBuilder.shaped(RecipeCategory.MISC, ModItems.GENERATOR_UPGRADE_SMITHING_TEMPLATE.get(), 2)
                ...
                .unlockedBy("has_generator_upgrade_smithing_template_2", ModRecipesProvider.has(ModItems.GENERATOR_UPGRADE_SMITHING_TEMPLATE.get()))
        ...
        // 海龟鳞片升级
        helper.tier1RecipeCDC(recipeOutput,
        ...
        // 黑曜石生成升级
        helper.tier1Recipe(recipeOutput,
        ...
        helper.fullGeneratorUpgradeChain(recipeOutput,
                CustomUpgradeItem.OBSIDIAN_GENERATOR_UPGRADE_1.get(),
        ...
        ShapedRecipeBuilder.shaped(RecipeCategory.MISC, CustomUpgradeItem.COBBLESTONE_GENERATOR_UPGRADE_1.get())
                ...
                .unlockedBy("has_cobblestone_generator_upgrade", ModRecipesProvider.has(StorageTags.DRAWER))
                .save(recipeOutput);
        helper.fullGeneratorUpgradeChain(recipeOutput,
