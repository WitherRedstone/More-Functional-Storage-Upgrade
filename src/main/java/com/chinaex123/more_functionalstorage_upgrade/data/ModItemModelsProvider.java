...
public class ModItemModelsProvider extends ItemModelProvider {
    ...
    protected void registerModels() {
        ...
        if (ModList.get().isLoaded("create")) {
            // 锆蓝石生成升级
            basicItem(CreateUpgradeItem.ASURINE_GENERATOR_UPGRADE_1.get());
            basicItem(CreateUpgradeItem.ASURINE_GENERATOR_UPGRADE_2.get());
            basicItem(CreateUpgradeItem.ASURINE_GENERATOR_UPGRADE_3.get());
            basicItem(CreateUpgradeItem.ASURINE_GENERATOR_UPGRADE_4.get());
            basicItem(CreateUpgradeItem.ASURINE_GENERATOR_UPGRADE_5.get());
            // 绯红岩生成升级
            basicItem(CreateUpgradeItem.CRIMSITE_GENERATOR_UPGRADE_1.get());
            basicItem(CreateUpgradeItem.CRIMSITE_GENERATOR_UPGRADE_2.get());
            basicItem(CreateUpgradeItem.CRIMSITE_GENERATOR_UPGRADE_3.get());
            basicItem(CreateUpgradeItem.CRIMSITE_GENERATOR_UPGRADE_4.get());
            basicItem(CreateUpgradeItem.CRIMSITE_GENERATOR_UPGRADE_5.get());
            // 赭金砂生成升级
            basicItem(CreateUpgradeItem.OCHRUM_GENERATOR_UPGRADE_1.get());
            basicItem(CreateUpgradeItem.OCHRUM_GENERATOR_UPGRADE_2.get());
            basicItem(CreateUpgradeItem.OCHRUM_GENERATOR_UPGRADE_3.get());
            basicItem(CreateUpgradeItem.OCHRUM_GENERATOR_UPGRADE_4.get());
            basicItem(CreateUpgradeItem.OCHRUM_GENERATOR_UPGRADE_5.get());
            // 辉绿岩生成升级
            basicItem(CreateUpgradeItem.VERIDIUM_GENERATOR_UPGRADE_1.get());
            basicItem(CreateUpgradeItem.VERIDIUM_GENERATOR_UPGRADE_2.get());
            basicItem(CreateUpgradeItem.VERIDIUM_GENERATOR_UPGRADE_3.get());
            basicItem(CreateUpgradeItem.VERIDIUM_GENERATOR_UPGRADE_4.get());
            basicItem(CreateUpgradeItem.VERIDIUM_GENERATOR_UPGRADE_5.get());
            // 石灰岩生成升级
            basicItem(CreateUpgradeItem.LIMESTONE_GENERATOR_UPGRADE_1.get());
            basicItem(CreateUpgradeItem.LIMESTONE_GENERATOR_UPGRADE_2.get());
            basicItem(CreateUpgradeItem.LIMESTONE_GENERATOR_UPGRADE_3.get());
            basicItem(CreateUpgradeItem.LIMESTONE_GENERATOR_UPGRADE_4.get());
            basicItem(CreateUpgradeItem.LIMESTONE_GENERATOR_UPGRADE_5.get());
            // 蜂蜜生成升级
            basicItem(CreateUpgradeItem.HONEY_GENERATOR_UPGRADE_1.get());
            basicItem(CreateUpgradeItem.HONEY_GENERATOR_UPGRADE_2.get());
            basicItem(CreateUpgradeItem.HONEY_GENERATOR_UPGRADE_3.get());
            basicItem(CreateUpgradeItem.HONEY_GENERATOR_UPGRADE_4.get());
            basicItem(CreateUpgradeItem.HONEY_GENERATOR_UPGRADE_5.get());
        }
    }
}
