...
public class CreativeTabFilter {
    /** 创造模式标签页按钮纹理位置 */
    private static final Identifier VANILLA_TABS = MoreFunctionalStorageUpgrade.id("textures/gui/container/creative_inventory/tabs.png");
    ...
    private static class FilterButton extends Button {
        ...
        public void extractContents(GuiGraphicsExtractor graphics, int mouseX, int mouseY, float partialTicks) {
            ...
            int textureX = active ? 31 : 1;
            int textureY = 1;
            int textureWidth = active ? 32 : 30;
            int textureHeight = 26;
            graphics.blit(RenderPipelines.GUI_TEXTURED, VANILLA_TABS, this.getX(), this.getY(),
                    textureX, textureY, textureWidth, textureHeight, 256, 256);
            graphics.item(this.category.icon.get(), this.getX() + 8, this.getY() + 5);
        }
